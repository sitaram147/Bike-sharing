...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        final_inputs = hidden_outputs.T * self.weights_hidden_to_output # signals into final output layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error =  error_term * self.weights_hidden_to_output
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        '''
        self.weights_hidden_to_output += self.lr * delta_weights_h_o / self.input_nodes # update hidden-to-output weights with gradient descent step
        self.weights_input_to_hidden += self.lr * delta_weights_i_h / self.input_nodes # update input-to-hidden weights with gradient descent step
